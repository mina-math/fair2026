...
const CHATBOT_FAQ = [
  ...
  },
  {
    ...
    answer: '🗺️ 박람회 당일(7/7)에는 9개 교과 부스를 방문할 수 있어요!\n\n국어, 수학, 영어, 사회, 과학, 기술가정·정보, 외국어·교양 부스에서 퀴즈에 참여할 수 있고, 진로진학상담·멘토상담 부스는 별도 신청으로 운영돼요.'
  },
  {
...
const BOOTHS = [
  ...
  { id:'tech',    name:'기술가정·정보', icon:'💻', color:'#D4A843', bg:'#FFF8E1', code:'TI06', desc:'기술가정·정보 교과 선택과목 안내' },
  { id:'foreign', name:'외국어·교양',  icon:'🌐', color:'#B8922E', bg:'#FFF8E1', code:'FL07', desc:'제2외국어·교양 교과 선택과목 안내' },
...
const QUIZZES = {
  ...
  tech: { questions:[
    ...
    { q:'기술·가정 교과의 일반선택 과목은?', opts:['로봇과 공학세계','기술·가정','창의 공학 설계','지식 재산 일반'], ans:1 },
    { q:'다음 중 정보 교과 융합선택 과목인 것은?', opts:['인공지능 기초','정보','소프트웨어와 생활','데이터 과학'], ans:2 },
  ]},
  foreign: { questions:[
    { q:'제2외국어 교과에 포함되지 않는 언어는?', opts:['일본어','베트남어','포르투갈어','아랍어'], ans:2 },
    { q:'교양 교과 일반선택 과목은?', opts:['철학','진로와 직업','인간과 심리','논술'], ans:1 },
    { q:'다음 중 제2외국어 진로선택 과목인 것은?', opts:['스페인어','심화 중국어','일본 문화','중국어'], ans:2 },
  ]},
  career: { questions:[
...
const INFO_HTML = [
  ...
  `<div class="info-card">
    ...
    <div style="display:flex;flex-direction:column;gap:14px;margin-top:16px;">
      <a href="https://storage.googleapis.com/fair2026-static/guidebook.pdf" target="_blank" style="
