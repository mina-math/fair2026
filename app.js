    ...
    el.innerHTML = `
      ...
      <div style="background:white; border-radius:16px; padding:16px; margin-bottom:14px; box-shadow:0 2px 8px rgba(0,0,0,0.05);">
        ...
        <div style="display:flex; gap:10px;">
          <a href="https://storage.googleapis.com/fair2026-static/guidebook.pdf" target="_blank" style="flex:1; text-decoration:none; display:flex; align-items:center; justify-content:center; gap:8px; background:linear-gradient(135deg, #1565C0, #0D47A1); color:white; border-radius:12px; padding:14px 10px; font-size:14px; font-weight:700; box-shadow:0 3px 10px rgba(21,101,192,0.3);">
            📄 책으로 보기
          </a>
